...
public class BitMap {
	...
	public BitMap(final int size) {
		this.size = size;
		int sLen = ((size % 32) == 0) ? size / 32 : size / 32 + 1; // 计算多少个int
		// 一个int 4
		// byte 32位
	...
	public static void main(String[] args) {
		...
		// int searchNum = 56;
		int searchNum = 99;
		int[] numArr = { 9, 64, 45, 56, 0, 54, 28, 2, 23, 34, 40, 18, 54, 50, 49, 29, 20, 31, 47, 30, 24, 17, 50, 57,
				33, 55, 21, 22, 27, 45, 3, 19, 17, 49, 24, 5, 15, 24, 27, 35, 6, 53, 9, 61, 4, 6, 12, 23, 52, 48, 39,
				39, 21, 1, 11 };
		bm.add(numArr);
		for (int i : numArr)
			System.out.println(bm.getIndex(i));

		System.out.println("catch ->" + bm.getIndex(searchNum));
	}
